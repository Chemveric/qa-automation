...
test.describe("API: reInvite team member to organization", () => {
  ...
  test(`Shoul send reinvite to existing teammate for buyer`, async () => {
  ...
  test(`Shoul send reinvite to existing teammate for vendor`, async () => {
    const api = new OrganizationsApiClient();
  ...
  test("should return 401 Unauthorized when reinvite with fake cookie", async () => {
    const api = new OrganizationsApiClient();
